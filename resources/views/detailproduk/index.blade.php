                                ...
                                <tr>
                                    ...
                                    <td>
                                        <img class="img-thumbnail"
                                            src="{{ asset('/foto/'.$row->author.'/'.$row->foto)}}"
                                            width="150">
                                            @if (auth()->user()->role=='admin')
                                        <p>
                                            <a href="{{ asset('/foto/'.$row->author.'/'.$row->foto)}}" download target="_blank"
                                    ...
                                    <td>
                                        <div class="btn-group btn-group-sm">
                                            ...
                                            <a href="/user/detailproduk/{{ $row->id }}/delete" class="btn btn-danger"><i
                                            ...
                                            <a href="/admin/detailproduk/{{ $row->id }}/delete" class="btn btn-danger"><i
                                                class="fas fa-trash"></i></a>
                                            @endif
                                        </div>
                                    </td>
    ...
    @foreach ($data as $row1)
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form action="/admin/detailproduk/{{ $row1->id }}/update" method="POST">
                    @csrf
